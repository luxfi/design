...
// @hanzo/design@0.5.24. Re-run `pnpm gen`.
/* eslint-disable */
...
export const typography = {
  ...
  'text-floor': '0.625rem',
  'text-ceiling': '30vw',
  'text-xs': 'clamp(var(--text-floor), calc((0.875rem - 0.1875rem * var(--type-ratio, 1)) * var(--type-scale, 1)), var(--text-ceiling))',
  'leading-xs': 'calc((1.35rem - 0.35rem * var(--type-ratio, 1)) * var(--type-scale, 1))',
  'text-sm': 'clamp(var(--text-floor), calc((0.875rem - 0.0625rem * var(--type-ratio, 1)) * var(--type-scale, 1)), var(--text-ceiling))',
  'leading-sm': 'calc((1.35rem - 0.2rem * var(--type-ratio, 1)) * var(--type-scale, 1))',
  'text-base': 'clamp(var(--text-floor), calc(0.875rem * var(--type-scale, 1)), var(--text-ceiling))',
  'leading-base': 'calc(1.35rem * var(--type-scale, 1))',
  'text-lg': 'clamp(var(--text-floor), calc((0.875rem + 0.0625rem * var(--type-ratio, 1)) * var(--type-scale, 1)), var(--text-ceiling))',
  'leading-lg': 'calc((1.35rem + 0.05rem * var(--type-ratio, 1)) * var(--type-scale, 1))',
  'text-xl': 'clamp(var(--text-floor), calc((0.875rem + 0.1875rem * var(--type-ratio, 1)) * var(--type-scale, 1)), var(--text-ceiling))',
  'leading-xl': 'calc((1.35rem + 0.2rem * var(--type-ratio, 1)) * var(--type-scale, 1))',
  'text-2xl': 'clamp(var(--text-floor), calc((0.875rem + 0.4375rem * var(--type-ratio, 1)) * var(--type-scale, 1)), var(--text-ceiling))',
  'leading-2xl': 'calc((1.35rem + 0.35rem * var(--type-ratio, 1)) * var(--type-scale, 1))',
  'text-3xl': 'clamp(var(--text-floor), calc((0.875rem + 0.75rem * var(--type-ratio, 1)) * var(--type-scale, 1)), var(--text-ceiling))',
  'leading-3xl': 'calc((1.35rem + 0.6rem * var(--type-ratio, 1)) * var(--type-scale, 1))',
  'text-4xl': 'clamp(var(--text-floor), calc((0.875rem + 1.125rem * var(--type-ratio, 1)) * var(--type-scale, 1)), var(--text-ceiling))',
  'leading-4xl': 'calc((1.35rem + 0.9rem * var(--type-ratio, 1)) * var(--type-scale, 1))',
  'text-5xl': 'clamp(var(--text-floor), calc((0.875rem + 1.625rem * var(--type-ratio, 1)) * var(--type-scale, 1)), var(--text-ceiling))',
  'leading-5xl': '1.05',
  'text-6xl': 'clamp(var(--text-floor), calc((0.875rem + 2.375rem * var(--type-ratio, 1)) * var(--type-scale, 1)), var(--text-ceiling))',
  'leading-6xl': '1',
  'text-7xl': 'clamp(var(--text-floor), calc((0.875rem + 3.125rem * var(--type-ratio, 1)) * var(--type-scale, 1)), var(--text-ceiling))',
  'leading-7xl': '1',
  'text-8xl': 'clamp(var(--text-floor), calc((0.875rem + 4.375rem * var(--type-ratio, 1)) * var(--type-scale, 1)), var(--text-ceiling))',
  'leading-8xl': '1',
  'text-9xl': 'clamp(var(--text-floor), calc((0.875rem + 6.125rem * var(--type-ratio, 1)) * var(--type-scale, 1)), var(--text-ceiling))',
  'leading-9xl': '1',
